...
//     ctx: &mut TxContext,
// ) {
//     assert!(has_permission(community, b"membership".to_string(), ctx));
//     let community_id = object::id(community);
...
//     ctx: &mut TxContext,
// ) {
//     assert!(has_permission(community, b"item".to_string(), ctx));
...
// public fun register_ticket_type(community: &mut Community, type_name: String, ctx: &mut TxContext) {
//     assert!(has_permission(community, b"ticket".to_string(), ctx));
//     let community_id = object::id(community);
//     dynamic_field::add(
//         &mut community.id,
...
public fun register_config_type(
    community: &mut Community,
    community_cap: &mut CommunityCap,
    type_name: String,
    content: String,
