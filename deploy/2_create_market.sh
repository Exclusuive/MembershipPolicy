...
sui client call  --package $PACKAGE_ID --module $COMMUNITY_MODULE --function grant_permission --type-args $PACKAGE_ID::$COMMUNITY_MODULE::MarketManager --args $COMMUNITY $COMMUNITY_CAP $RECEIVER

echo "Creating New Market"
sui client call  --package $PACKAGE_ID --module $MARKET_MODULE --function new_market --args $COMMUNITY
